...
Hasil di atas menunjukkan bahwa selain peubah xt−1, hasil uji t menunjukkan nilai-p pada peubah ≥0.05 Hal ini menunjukkan bahwa peubah xt−1 berpengaruh signifikan terhadap yt, sementara xt dan yt−1 berpengaruh signifikan terhadap yt. Model keseluruhannya adalah sebagai berikut:
...
BIC(model.ardl.opt2)
```
asil di atas menunjukkan bahwa selain peubah xt−1, hasil uji t menunjukkan nilai-p pada peubah ≥0.05 Hal ini menunjukkan bahwa peubah xt−1 berpengaruh signifikan terhadap yt, sementara xt dan yt−1 berpengaruh signifikan terhadap yt. Model keseluruhannya adalah sebagai berikut:
```{r}
...
GoF(model.ardl.opt2)
```
Berdasarkan akurasi di atas, terlihat bahwa nilai MAPE keduanya tidak jauh berbeda.
